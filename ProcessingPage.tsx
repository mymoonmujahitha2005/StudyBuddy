  ...
  useEffect(() => {
    ...
    const runProcess = async () => {
      ...
      try {
        ...
        } else if (err.message && (err.message.includes('503') || err.message.includes('UNAVAILABLE'))) {
          errorMsg = 'The Gemini AI is currently receiving high cosmic traffic (Heavy Load). I attempted to retry, but you might need to try again in a few minutes.';
